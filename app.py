...
You can also choose **Fully random** to generate and benchmark a standalone dataset without uploading a database. The upload contract and source history are documented separately in [SCHEMA_PROVENANCE.md](https://github.com/g497813927/c-store-poc/blob/main/SCHEMA_PROVENANCE.md).
"""
    )
    gr.Markdown(
